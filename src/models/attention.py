...
class Seq2SeqWithAttention(nn.Module):
    ...
    def forward(
        ...
        for i in range(self.max_sequence_size):
            ...
            print(f"enc_output: {enc_output.size()}")
            print(f"enc_hidden: {enc_hidden[0].size()}")
            print(f"enc_cell: {enc_hidden[1].size()}")
        ...
        for i in range(self.max_sequence_size):
            ...
            dec_output_i, dec_hidden, _ = self.decoder(
